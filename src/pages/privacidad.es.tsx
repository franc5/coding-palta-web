...
export default function PrivacyPage() {
  return (
    <>
      <OneTopicSection title="Privacy Policy">
        <div className="row left-align">
          ...
          <Section title="Interpretation and Definitions">
            <>
              ...
              <ul>
                ...
                <li>
                  <p><strong>Website</strong> refers to Coding Palta, accessible from <a href="https://codingpalta.com" rel="external nofollow noopener" target="_blank">https://codingpalta.com</a></p>
                </li>
                <li>
          ...
          <Section title="Contact Us">
              <p>
                If you have any questions about these Privacy Policy, You can contact us by visiting this page on our website: <Link to="/contact">https://codingpalta.com/contact</Link>
              </p>
          </Section>
        </div>
      </OneTopicSection>
