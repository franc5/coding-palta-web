...
export default function TermsPage() {
  return (
    <>
      <OneTopicSection title="Terms and Conditions">
        <div className="row left-align">
          ...
          <Section title="Interpretation and Definitions">
            <>
              ...
              <ul>
                ...
                <li>
                  <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Coding Palta LLC, 530-B Harkle Road STE 100, Santa Fe, NM 87505.</p>
                </li>
                <li>
                ...
                <li>
                  <p><strong>Website</strong> refers to Coding Palta LLC, accessible from <a href="https://codingpalta.com" rel="external nofollow noopener" target="_blank">https://codingpalta.com</a></p>
                </li>
                <li>
          ...
          <Section title="Contact Us">
              <p>
                If you have any questions about these Terms and Conditions, You can contact us by visiting this page on our website: <Link to="/contact">https://codingpalta.com/contact</Link>
              </p>
          </Section>
        </div>
      </OneTopicSection>
